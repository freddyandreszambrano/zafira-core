...
from core.scraper.parsers import extract_category_path, extract_images, normalize_price, now_iso
...
class TestExtractImages(SimpleTestCase):
    ...
    def test_extract_single_image_with_src(self):
        ...
        mock_img = Mock()
        mock_img.get.side_effect = (
            lambda attr: "https://example.com/image.jpg" if attr == "src" else None
        )
    ...
    def test_extract_image_with_data_src(self):
        ...
        mock_img = Mock()
        mock_img.get.side_effect = (
            lambda attr: "https://example.com/lazy.jpg" if attr == "data-src" else None
        )
    ...
    def test_extract_multiple_images(self):
        ...
        mock_img1 = Mock()
        mock_img1.get.side_effect = (
            lambda attr: "https://example.com/image1.jpg" if attr == "src" else None
        )

        mock_img2 = Mock()
        mock_img2.get.side_effect = (
            lambda attr: "https://example.com/image2.jpg" if attr == "src" else None
        )
    ...
    def test_skip_data_uri(self):
        ...
        mock_img = Mock()
        mock_img.get.side_effect = (
            lambda attr: "data:image/png;base64,ABC123" if attr == "src" else None
        )
    ...
    def test_mixed_src_and_data_src(self):
        ...
        mock_img2 = Mock()
        mock_img2.get.side_effect = (
            lambda attr: None if attr == "src" else "https://example.com/image2.jpg"
        )
